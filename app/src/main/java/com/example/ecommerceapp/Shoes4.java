...
public class Shoes4 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName=(TextView) findViewById(R.id.ProductName4);
        productPrice=(TextView) findViewById(R.id.ProductPrice4);
        addToCartButton=(Button) findViewById(R.id.pd_add_to_cart_button4);
        btn = (ElegantNumberButton) findViewById(R.id.Quantity4);
        ShippingList=(Spinner)findViewById(R.id.Shipping4);
        SizeShoes=(Spinner) findViewById(R.id.ShoesSize4);
        btnFavouriteProduct=(Button) findViewById(R.id.Favourite_button4);
        ...
        Spinner spinner = findViewById(R.id.Shipping4);
        ...
        spinner = findViewById(R.id.ShoesSize4);
        ...
        FavproductName=(TextView) findViewById(R.id.ProductName4);
        FavproductPrice=(TextView) findViewById(R.id.ProductPrice4);
        Favbtn = (ElegantNumberButton) findViewById(R.id.Quantity4);
        FavProductSize=(Spinner) findViewById(R.id.ShoesSize4);
        FavShippingList=(Spinner)findViewById(R.id.Shipping4);
        btnFavouriteProduct=(Button) findViewById(R.id.Favourite_button4);
        ...
        btnFavouriteProduct.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Shoes4.this,"add to Favorite Successful",Toast.LENGTH_LONG).show();
