...
public class Bag2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bagitem2);

        getSupportActionBar().setTitle("No Limits");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        productName=(TextView) findViewById(R.id.ProductNameb2);
        productPrice=(TextView) findViewById(R.id.ProductPriceb2);
        addToCartButton=(Button) findViewById(R.id.pd_add_to_cart_buttonb2);
        btn = (ElegantNumberButton) findViewById(R.id.Quantityb2);
        ProductSize=(Spinner) findViewById(R.id.Sizeb2);
        ShippingList=(Spinner)findViewById(R.id.Shippingb2);
        btnFavouriteProduct=(Button) findViewById(R.id.Favourite_buttonb2);
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Toast.makeText(Bag2.this,"add to cart Successful",Toast.LENGTH_LONG).show();
            }
        ...
        Spinner spinner = findViewById(R.id.Shippingb2);
        ...
        spinner = findViewById(R.id.Sizeb2);
        ...
        FavproductName=(TextView) findViewById(R.id.ProductNameb2);
        FavproductPrice=(TextView) findViewById(R.id.ProductPriceb2);
        Favbtn = (ElegantNumberButton) findViewById(R.id.Quantityb2);
        FavShippingList=(Spinner)findViewById(R.id.Shippingb2);
        btnFavouriteProduct=(Button) findViewById(R.id.Favourite_buttonb2);
        ...
        btnFavouriteProduct.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
               ...
               // favourite.setFavShipping(FavShippingList.getSelectedItem().toString());
                ...
                Toast.makeText(Bag2.this,"add to Favorite Successful",Toast.LENGTH_LONG).show();
