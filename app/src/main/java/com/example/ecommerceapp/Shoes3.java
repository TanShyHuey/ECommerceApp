...
public class Shoes3 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shoesitem3);
        ...
        addToCartButton=(Button) findViewById(R.id.pd_add_to_cart_button3);
        btn = (ElegantNumberButton) findViewById(R.id.Quantity3);
        ShippingList=(Spinner)findViewById(R.id.Shipping3);
        SizeShoes=(Spinner) findViewById(R.id.ShoesSize3);
        btnFavouriteProduct=(Button) findViewById(R.id.Favourite_button3);
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Toast.makeText(Shoes3.this,"add to cart Successful",Toast.LENGTH_LONG).show();
            }
        ...
        Spinner spinner = findViewById(R.id.Shipping3);
        ...
        spinner = findViewById(R.id.ShoesSize3);
        ...
        FavproductName=(TextView) findViewById(R.id.ProductName3);
        FavproductPrice=(TextView) findViewById(R.id.ProductPrice3);
        Favbtn = (ElegantNumberButton) findViewById(R.id.Quantity3);
        FavProductSize=(Spinner) findViewById(R.id.ShoesSize3);
        FavShippingList=(Spinner)findViewById(R.id.Shipping3);
        btnFavouriteProduct=(Button) findViewById(R.id.Favourite_button3);
